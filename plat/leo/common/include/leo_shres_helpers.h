...
#ifndef LEO_SHRES_HELPERS_H
#define LEO_SHRES_HELPERS_H
...
static inline int leo_incr_shrefcnt(unsigned int *refcnt, bool secure)
{
	int rc = !*refcnt;
...
static inline int leo_decr_shrefcnt(unsigned int *refcnt, bool secure)
{
	int  rc = 0;
...
static inline int leo_incr_refcnt(unsigned int *refcnt)
{
	return leo_incr_shrefcnt(refcnt, true);
}

static inline int leo_decr_refcnt(unsigned int *refcnt)
{
	return leo_decr_shrefcnt(refcnt, true);
}

#endif /* LEO_SHRES_HELPERS_H */
