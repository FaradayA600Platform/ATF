...
#define LEO_PRIMARY_CPU		U(0x0)
#define LEO_SECONDARY_CPU		U(0x1)
 ...
 */
#define BL2_BASE			LEO_BL2_BASE
#define BL2_LIMIT			(LEO_BL2_BASE + \
					 LEO_BL2_SIZE)
...
#define BL32_BASE			LEO_BL32_BASE
#define BL32_LIMIT			(LEO_BL32_BASE + \
					 LEO_BL32_SIZE)
#endif
 ...
 ******************************************************************************/
#define BL33_BASE			LEO_BL33_BASE

/*
 * Load address of BL33 for this platform port
 */
#define PLAT_LEO_NS_IMAGE_OFFSET	BL33_BASE

/*******************************************************************************
 * DTB specific defines.
 ******************************************************************************/
#define DTB_BASE			LEO_DTB_BASE
#define DTB_LIMIT			(LEO_DTB_BASE + \
					 LEO_DTB_SIZE)
...
#define LEO1_IRQ_TZC400		U(36)
#define LEO1_IRQ_TAMPSERRS		U(229)
#define LEO1_IRQ_AXIERRIRQ		U(244)
...
#define PLATFORM_G1S_PROPS(grp) \
	...
	INTR_PROP_DESC(LEO1_IRQ_AXIERRIRQ,		\
		       GIC_HIGHEST_SEC_PRIORITY,	\
		       grp, GIC_INTR_CFG_LEVEL),	\
	INTR_PROP_DESC(LEO1_IRQ_TZC400,		\
		       GIC_HIGHEST_SEC_PRIORITY,	\
		       grp, GIC_INTR_CFG_LEVEL),	\
