...
static const gicv2_driver_data_t a600_gic_data = {
	.gicd_base = A600_GICD_BASE,
	.gicc_base = A600_GICC_BASE,
};
...

{
	 ...
	 */
	assert(arg1 == A600_BL31_PLAT_PARAM_VAL);
...
# if A600_BL33_IN_AARCH32
	 ...
	 */
	VERBOSE("a600: Preparing to boot 32-bit Linux kernel\n");
	bl33_image_ep_info.args.arg0 = 0U;
	bl33_image_ep_info.args.arg1 = ~0U;
	bl33_image_ep_info.args.arg2 = (u_register_t) A600_PRELOADED_DTB_BASE;
# else
	/*
	 ...
	 * must be 0.
	 */
	VERBOSE("a600: Preparing to boot 64-bit Linux kernel\n");
	bl33_image_ep_info.args.arg0 = (u_register_t) A600_PRELOADED_DTB_BASE;
	bl33_image_ep_info.args.arg1 = 0ULL;
	bl33_image_ep_info.args.arg2 = 0ULL;
	bl33_image_ep_info.args.arg3 = 0ULL;
# endif /* A600_BL33_IN_AARCH32 */
#endif /* A600_DIRECT_LINUX_BOOT */
}

void bl31_plat_arch_setup(void)
{
	a600_setup_page_tables(BL31_BASE, BL31_END - BL31_BASE,
 ...
 */
static void a600_dtb_add_mem_rsv(void)
{
	int i, regions, rc;
	uint64_t addr, size;
	void *dtb = (void *)A600_PRELOADED_DTB_BASE;

	INFO("a600: Checking DTB...\n");
	...
	VERBOSE("a600: Found %d mem reserve region(s)\n", regions);
	...
	for (i = 0; i < regions; i++) {
		...
		VERBOSE("a600: Firmware mem reserve region found\n");

		rc = fdt_del_mem_rsv(dtb, i);
		if (rc != 0) {
			INFO("a600: Can't remove mem reserve region (%d)\n", rc);
		}
	...
	if (i == regions) {
		VERBOSE("a600: Firmware mem reserve region not found\n");
	}
	...
	if (rc != 0) {
		WARN("a600: Can't add mem reserve region (%d)\n", rc);
	}

	INFO("a600: Reserved 0x%llx - 0x%llx in DTB\n", SEC_SRAM_BASE,
...
void bl31_platform_setup(void)
{
	...
	a600_dtb_add_mem_rsv();
#endif

	/* Configure the interrupt controller */
	gicv2_driver_init(&a600_gic_data);
	gicv2_distif_init();
